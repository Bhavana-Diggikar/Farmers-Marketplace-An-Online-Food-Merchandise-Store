				...
				<div className="row justify-content-sm-center h-100">
					<div className="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
						<div className="text-center my-5">
							<img src="https://e7.pngegg.com/pngimages/440/882/png-clipart-vegetable-farmers-market-logo-agricultural-manager-food-open-market-logo.png" alt="logo" width="100" style={{ borderRadius: '50px' }} />
						</div>
						...
						<div className="text-center mt-5 text-muted">
							Copyright &copy; 2026 &mdash; FarmersMarket
						</div>
					</div>
				</div>
			</div>
